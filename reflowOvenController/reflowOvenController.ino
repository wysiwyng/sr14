...
typedef enum DEBOUNCE_STATE_PRE
{
  DEBOUNCE_STATE_PRE_IDLE,
  DEBOUNCE_STATE_PRE_CHECK,
  DEBOUNCE_STATE_PRE_RELEASE
}       
debounceStatePre_t;
...
debounceStatePre_t debounceStatePre;
// Switch debounce timer
long lastDebounceTime;
// Switch press status
switch_t switchStatus;

switchPre_t switchPreStatus;
// Seconds timer
int timerSeconds;
